...
**Subtarefas**
- [ ] **0.1.1** Criar diretório do projeto finanpy
- [ ] **0.1.2** Criar ambiente virtual Python: uv init
- [ ] **0.1.3** Ativar ambiente virtual
- [ ] **0.1.4** Criar arquivo: uv add <lib> com dependências iniciais:
````bash
- Django==6.0
- python-decouple==3.8
````
- [ ] **0.1.5**: Criar arquivo .gitignore com conteúdo padrão para Django:
...
**Subtarefas**:
- [ ] 0.2.1: Criar projeto Django: `django-admin startproject core .`
- [ ] 0.2.2: Renomear diretório do projeto de `core` para `core` se necessário
- [ ] 0.2.3: Testar servidor de desenvolvimento: `task runserver`
- [ ] 0.2.4: Verificar acesso em `http://localhost:8000`
...
**Subtarefas**:
- [ ] 0.4.1: Criar app `users`: `task startapp users`
- [ ] 0.4.2: Criar app `profiles`: `task startapp profiles`
- [ ] 0.4.3: Criar app `accounts`: `task startapp accounts`
- [ ] 0.4.4: Criar app `categories`: `task startapp categories`
- [ ] 0.4.5: Criar app `transactions`: `task startapp transactions`
...
**Subtarefas**:
- [ ] 0.5.1: Instalar django-tailwind: adicionar `uv add django-tailwind==3.8.0`
- [ ] 0.5.2: Adicionar 'tailwind' ao INSTALLED_APPS
- [ ] 0.5.3: Executar: `uv run python manage.py tailwind init`
- [ ] 0.5.4: Adicionar app theme gerado ao INSTALLED_APPS
- [ ] 0.5.5: Configurar TAILWIND_APP_NAME no settings.py
- [ ] 0.5.6: Instalar dependências do Tailwind: `uv run python manage.py tailwind install`
- [ ] 0.5.7: Configurar NPM_BIN_PATH no settings.py se necessário
...
- [ ] 3.1.5: Criar choices para category_type (INCOME, E PENSE)
...
- [ ] 4.1.6: Criar choices para transaction_type (INCOME, E PENSE)
...
- [ ] 4.2.5: Implementar lógica: se INCOME adiciona, se E PENSE subtrai
...
- [ ] 4.6.12: Usar cores diferentes para INCOME (verde) e E PENSE (vermelho)
...
- [ ] 6.2.4: Adicionar "Mostrar   por página"
...
- [ ] 6.9.7: Testar  SS (Django já protege)
